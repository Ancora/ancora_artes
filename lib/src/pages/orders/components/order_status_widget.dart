...
class OrderStatusWidget extends StatelessWidget {
  ...
  int get currentStatus =>
      allStatus[status]!; // exclamação indica que não será nulo
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Lógica para ver situação da etapa
        if (currentStatus == 1) ...[
          const _StatusDot(
            isActive: true,
            title: 'PIX estornado',
...
// Widget para divisor vertical entre os dots
...
// Widget privado(_) para mostrar a lista de status
